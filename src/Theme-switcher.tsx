    ...
    return (
        <>
            <div className='flex flex-row items-center gap-4'>
                <p className={`font-semibold text-[0.8rem] ${theme === 'light' ? 'text-[#4f6c99]' : 'text-[#d7d8dc]'}`}>{theme === 'light' ? 'DARK' : 'LIGHT'}</p>
                {
                    theme === 'light' ?
                    ...
                    : (<svg onClick={handleThemeToggle} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 fill-[#fefeff] cursor-pointer">
