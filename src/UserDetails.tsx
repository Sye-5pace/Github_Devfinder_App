            ...
            <main className='flex flex-col gap-y-6 pt-10 h-[30rem] bg-[#fffffe]'>
                ...
                <section className='ml-[9.4rem] mr-4 mx-4 '>
                    ...
                    <div className='w-full rounded-[0.8rem] h-[8rem] bg-[#f4f9ff] flex flex-row gap-10 items-center justify-center'>
                        ...
                        <div className='flex flex-col'>
                            <p className='text-[#a7b0c0]'>Followers</p>
                            <p className='font-bold text-[1.1rem]'>{data.followers}</p>
                        </div>
                        <div className='flex flex-col'>
                            <p className='text-[#a7b0c0] '>Following</p>
                            <p className='font-bold text-[1.1rem]'>{data.following}</p>
                        </div>
                    </div>
                </section>
                <section className='text-[#b4b7c2] flex flex-row gap-6 items-center self-end mr-6'>
                    ...
                    <div className='flex flex-col gap-y-2'>
                        <div className='flex gap-2'>
                            <svg className='w-6 h-6 fill-[#4c6896]' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0z">
