...
const SearchUser = ({ username, setUsername, handleRequest }) => {
    // const [user,setUser] = useState("")


    return (
        <div className='' >
            <section className='w-full h-[4.5rem] flex flex-row items-center justify-between gap-6 pl-4 pr-1  bg-[#fffffe] rounded-[0.6rem]'>
